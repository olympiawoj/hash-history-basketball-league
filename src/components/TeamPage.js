...
export default class TeamPage extends Component {
    ...
    render() {
        ...
        return (
            <div>
                {/*must pass func as chuld*/}
                < Team id={teamId} >
                    {(team) => team === null ?
                        <Loading text="Loading Team Page"></Loading>
                        : <div className="panel">
                            <TeamLogo id={teamId} />
                            <h1 className="medium-header">{team.name}</h1>
                            <h4 style={{ margin: 5 }}>
                                <Link style={{ cursor: "pointer" }} to={{ pathname: `/players`, search: `?teamId=${teamId}` }}> View Roster</Link>
                            </h4>
                            ...
                            <ul className="info-list row" style={{ width: "100%" }}>
                                ...
                                <li>Record <div>{team.losses}</div></li>
                            </ul>
